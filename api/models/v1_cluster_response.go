...
func (m *V1ClusterResponse) validateKubeAPIServerACL(formats strfmt.Registry) error {
...
func (m *V1ClusterResponse) contextValidateKubeAPIServerACL(ctx context.Context, formats strfmt.Registry) error {
