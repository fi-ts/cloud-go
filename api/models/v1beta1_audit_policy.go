...
// V1beta1AuditPolicy v1beta1 audit policy
// swagger:model v1beta1.AuditPolicy
...
// Validate validates this v1beta1 audit policy
func (m *V1beta1AuditPolicy) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1beta1AuditPolicy) validateConfigMapRef(formats strfmt.Registry) error {
