...
func (m *V1AuditBackendClusterForwarding) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1AuditBackendClusterForwarding) validateEnabled(formats strfmt.Registry) error {
...
func (m *V1AuditBackendClusterForwarding) UnmarshalBinary(b []byte) error {
	var res V1AuditBackendClusterForwarding
