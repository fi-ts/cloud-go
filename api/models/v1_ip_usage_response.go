...
type V1IPUsageResponse struct {
	...
	// Required: true
	Accumulatedusage *V1IPUsageAccumuluated `json:"accumulatedusage" yaml:"accumulatedusage"`
	...
	// Required: true
	Usage []*V1IPUsage `json:"usage" yaml:"usage"`
}
...
func (m *V1IPUsageResponse) validateAccumulatedusage(formats strfmt.Registry) error {
...
func (m *V1IPUsageResponse) validateFrom(formats strfmt.Registry) error {
...
func (m *V1IPUsageResponse) validateTo(formats strfmt.Registry) error {
...
func (m *V1IPUsageResponse) validateUsage(formats strfmt.Registry) error {
...
func (m *V1IPUsageResponse) contextValidateAccumulatedusage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1IPUsageResponse) contextValidateUsage(ctx context.Context, formats strfmt.Registry) error {
