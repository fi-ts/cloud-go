...
type V1NetworkUsageResponse struct {
	...
	// Required: true
	Accumulatedusage *V1NetworkUsageAccumuluated `json:"accumulatedusage" yaml:"accumulatedusage"`
...
func (m *V1NetworkUsageResponse) contextValidateUsage(ctx context.Context, formats strfmt.Registry) error {
