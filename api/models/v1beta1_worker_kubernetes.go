...
// V1beta1WorkerKubernetes v1beta1 worker kubernetes
// swagger:model v1beta1.WorkerKubernetes
...
// Validate validates this v1beta1 worker kubernetes
func (m *V1beta1WorkerKubernetes) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1beta1WorkerKubernetes) validateKubelet(formats strfmt.Registry) error {
...
func (m *V1beta1WorkerKubernetes) UnmarshalBinary(b []byte) error {
	var res V1beta1WorkerKubernetes
