...
// ContextValidate validates this models v1 machine disk partition based on context it is used
func (m *ModelsV1MachineDiskPartition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
