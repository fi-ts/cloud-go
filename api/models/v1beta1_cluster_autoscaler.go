...
// V1beta1ClusterAutoscaler v1beta1 cluster autoscaler
// swagger:model v1beta1.ClusterAutoscaler
...
// Validate validates this v1beta1 cluster autoscaler
func (m *V1beta1ClusterAutoscaler) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *V1beta1ClusterAutoscaler) UnmarshalBinary(b []byte) error {
	var res V1beta1ClusterAutoscaler
