...
type V1IAMConfig struct {
	...
	// group config
	GroupConfig *V1NamespaceGroupConfig `json:"group_config,omitempty"`
...
func (m *V1IAMConfig) validateGroupConfig(formats strfmt.Registry) error {
	...
	if m.GroupConfig != nil {
		if err := m.GroupConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("group_config")
			}
			return err
		}
	}
