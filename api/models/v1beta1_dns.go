...
// V1beta1DNS v1beta1 DNS
// swagger:model v1beta1.DNS
...
// Validate validates this v1beta1 DNS
func (m *V1beta1DNS) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1beta1DNS) validateProviders(formats strfmt.Registry) error {
