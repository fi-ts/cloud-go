...
// V1alpha1KubeAPIServerConfig v1alpha1 kube API server config
// swagger:model v1alpha1.KubeAPIServerConfig
type V1alpha1KubeAPIServerConfig struct {

	// admission plugins
	AdmissionPlugins []*V1alpha1AdmissionPlugin `json:"admissionPlugins"`

	// api audiences
	APIAudiences []string `json:"apiAudiences"`

	// audit config
	AuditConfig *V1alpha1AuditConfig `json:"auditConfig,omitempty"`
	...
	// oidc config
	OidcConfig *V1alpha1OIDCConfig `json:"oidcConfig,omitempty"`

	// runtime config
	RuntimeConfig map[string]bool `json:"runtimeConfig,omitempty"`

	// service account config
	ServiceAccountConfig *V1alpha1ServiceAccountConfig `json:"serviceAccountConfig,omitempty"`
}

// Validate validates this v1alpha1 kube API server config
func (m *V1alpha1KubeAPIServerConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1alpha1KubeAPIServerConfig) validateAdmissionPlugins(formats strfmt.Registry) error {
...
func (m *V1alpha1KubeAPIServerConfig) validateAuditConfig(formats strfmt.Registry) error {
...
func (m *V1alpha1KubeAPIServerConfig) validateOidcConfig(formats strfmt.Registry) error {
...
func (m *V1alpha1KubeAPIServerConfig) validateServiceAccountConfig(formats strfmt.Registry) error {
...
func (m *V1alpha1KubeAPIServerConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1alpha1KubeAPIServerConfig) UnmarshalBinary(b []byte) error {
	var res V1alpha1KubeAPIServerConfig
