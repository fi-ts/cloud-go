...
func (m *V1ProductOptionUsageRequest) validateFrom(formats strfmt.Registry) error {
...
func (m *V1ProductOptionUsageRequest) validateTo(formats strfmt.Registry) error {
...
func (m *V1ProductOptionUsageRequest) UnmarshalBinary(b []byte) error {
	var res V1ProductOptionUsageRequest
