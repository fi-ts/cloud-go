...
func (m *V1ProductOptionUsageAccumuluated) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ProductOptionUsageAccumuluated) validateLifetime(formats strfmt.Registry) error {
...
func (m *V1ProductOptionUsageAccumuluated) UnmarshalBinary(b []byte) error {
	var res V1ProductOptionUsageAccumuluated
