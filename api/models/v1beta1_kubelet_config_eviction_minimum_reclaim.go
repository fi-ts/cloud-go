...
// V1beta1KubeletConfigEvictionMinimumReclaim v1beta1 kubelet config eviction minimum reclaim
// swagger:model v1beta1.KubeletConfigEvictionMinimumReclaim
...
// Validate validates this v1beta1 kubelet config eviction minimum reclaim
func (m *V1beta1KubeletConfigEvictionMinimumReclaim) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *V1beta1KubeletConfigEvictionMinimumReclaim) UnmarshalBinary(b []byte) error {
	var res V1beta1KubeletConfigEvictionMinimumReclaim
