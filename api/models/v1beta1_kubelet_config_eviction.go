...
// V1beta1KubeletConfigEviction v1beta1 kubelet config eviction
// swagger:model v1beta1.KubeletConfigEviction
...
// Validate validates this v1beta1 kubelet config eviction
func (m *V1beta1KubeletConfigEviction) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *V1beta1KubeletConfigEviction) UnmarshalBinary(b []byte) error {
	var res V1beta1KubeletConfigEviction
