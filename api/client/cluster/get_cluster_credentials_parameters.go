...
// WithID adds the id to the get cluster credentials params
func (o *GetClusterCredentialsParams) WithID(id string) *GetClusterCredentialsParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get cluster credentials params
func (o *GetClusterCredentialsParams) SetID(id string) {
	o.ID = id
}
