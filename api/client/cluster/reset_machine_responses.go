...
func (o *ResetMachineOK) Error() string {
	...
	return fmt.Sprintf("[POST /v1/cluster/{id}/resetmachine][%d] resetMachineOK %s", 200, payload)
}
...
func (o *ResetMachineDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/cluster/{id}/resetmachine][%d] resetMachine default %s", o._statusCode, payload)
}
