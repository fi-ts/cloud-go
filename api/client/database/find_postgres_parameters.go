...
// NewFindPostgresParams creates a new FindPostgresParams object,
...
func NewFindPostgresParams() *FindPostgresParams {
	return &FindPostgresParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewFindPostgresParamsWithTimeout creates a new FindPostgresParams object
...
// NewFindPostgresParamsWithContext creates a new FindPostgresParams object
...
// NewFindPostgresParamsWithHTTPClient creates a new FindPostgresParams object
...
func (o *FindPostgresParams) WithContext(ctx context.Context) *FindPostgresParams {
	o.SetContext(ctx)
	return o
}
...
func (o *FindPostgresParams) WithBody(body *models.V1PostgresFindRequest) *FindPostgresParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the find postgres params
func (o *FindPostgresParams) SetBody(body *models.V1PostgresFindRequest) {
	o.Body = body
}
