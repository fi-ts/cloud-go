...
func (o *AcceptPostgresRestoreOK) Error() string {
	return fmt.Sprintf("[POST /v1/database/postgres/restore][%d] acceptPostgresRestoreOK  %+v", 200, o.Payload)
}
...
func (o *AcceptPostgresRestoreDefault) Error() string {
	return fmt.Sprintf("[POST /v1/database/postgres/restore][%d] acceptPostgresRestore default  %+v", o._statusCode, o.Payload)
}
