...
func (o *DeleteSnapshotOK) Error() string {
	return fmt.Sprintf("[DELETE /v1/volume/{id}][%d] deleteSnapshotOK  %+v", 200, o.Payload)
}
...
func (o *DeleteSnapshotDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/volume/{id}][%d] deleteSnapshot default  %+v", o._statusCode, o.Payload)
}
