...
func (o *DeleteMachineReservationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteMachineReservationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDeleteMachineReservationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteMachineReservationOK() *DeleteMachineReservationOK {
	return &DeleteMachineReservationOK{}
}
...
func (o *DeleteMachineReservationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteMachineReservationDefault(code int) *DeleteMachineReservationDefault {
	return &DeleteMachineReservationDefault{
		_statusCode: code,
	}
}
...
Error
*/
type DeleteMachineReservationDefault struct {
	_statusCode int
...
func (o *DeleteMachineReservationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
