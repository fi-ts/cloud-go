...
type UpdateParams struct {
	...
	// Body.
	Body *models.V1GatewayUpdateRequest
...
func (o *UpdateParams) WithBody(body *models.V1GatewayUpdateRequest) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.V1GatewayUpdateRequest) {
	o.Body = body
}
