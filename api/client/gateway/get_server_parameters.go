...
// WithProjectuid adds the projectuid to the get server params
func (o *GetServerParams) WithProjectuid(projectuid string) *GetServerParams {
	o.SetProjectuid(projectuid)
	return o
}

// SetProjectuid adds the projectuid to the get server params
func (o *GetServerParams) SetProjectuid(projectuid string) {
