...
// WithBody adds the body to the describe instance params
func (o *DescribeInstanceParams) WithBody(body *models.V1GatewayInstanceIdentity) *DescribeInstanceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the describe instance params
func (o *DescribeInstanceParams) SetBody(body *models.V1GatewayInstanceIdentity) {
	o.Body = body
}
