...
// WithProjectuid adds the projectuid to the list servers params
func (o *ListServersParams) WithProjectuid(projectuid string) *ListServersParams {
	o.SetProjectuid(projectuid)
	return o
}

// SetProjectuid adds the projectuid to the list servers params
func (o *ListServersParams) SetProjectuid(projectuid string) {
