...
type DeleteParams struct {
	...
	// Body.
	Body *models.V1GatewayDeleteRequest
...
func (o *DeleteParams) WithBody(body *models.V1GatewayDeleteRequest) *DeleteParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete params
func (o *DeleteParams) SetBody(body *models.V1GatewayDeleteRequest) {
	o.Body = body
}
