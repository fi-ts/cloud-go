...
// WithProjectuid adds the projectuid to the server list params
func (o *ServerListParams) WithProjectuid(projectuid string) *ServerListParams {
	o.SetProjectuid(projectuid)
	return o
}

// SetProjectuid adds the projectuid to the server list params
func (o *ServerListParams) SetProjectuid(projectuid string) {
