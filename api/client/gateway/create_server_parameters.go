...
type CreateServerParams struct {
	...
	// Body.
	Body *models.V1GatewayCreateInstanceRequest
...
func (o *CreateServerParams) WithBody(body *models.V1GatewayCreateInstanceRequest) *CreateServerParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create server params
func (o *CreateServerParams) SetBody(body *models.V1GatewayCreateInstanceRequest) {
	o.Body = body
}
