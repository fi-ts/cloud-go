...
func (o *CreateGatewayParams) WithBody(body *models.V1GatewayCreateRequest) *CreateGatewayParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create gateway params
func (o *CreateGatewayParams) SetBody(body *models.V1GatewayCreateRequest) {
	o.Body = body
}
