...
// WithName adds the name to the server delete params
func (o *ServerDeleteParams) WithName(name string) *ServerDeleteParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the server delete params
func (o *ServerDeleteParams) SetName(name string) {
	o.Name = name
}

// WithProjectuid adds the projectuid to the server delete params
func (o *ServerDeleteParams) WithProjectuid(projectuid string) *ServerDeleteParams {
	o.SetProjectuid(projectuid)
	return o
}

// SetProjectuid adds the projectuid to the server delete params
func (o *ServerDeleteParams) SetProjectuid(projectuid string) {
